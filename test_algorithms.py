...
class TestAlgorithms:
    ...
    def run_original(self, dataset_orig_train, dataset_orig_val, dataset_orig_test, model_type, orig_metrics, orig_mia_metrics, f_label, 
        ...
        orig_metrics, orig_mia_metrics = null_mitigator.run_mitigator(dataset_orig_train, dataset_orig_val, dataset_orig_test, model_type, orig_metrics, orig_mia_metrics, f_label, uf_label, unprivileged_groups, privileged_groups, ATTACK, THRESH_ARR, DISPLAY, SCALER, target_dataset, reference_dataset)

        # null_mitigator.run_explainer(dataset_orig_train, dataset_orig_test, model_type, SCALER)
        return orig_metrics, orig_mia_metrics

    def run_oversample(self,dataset_orig_train, dataset_orig_val, dataset_orig_test, privileged_groups, unprivileged_groups, 
    ...
    def run_dir(self, dataset_orig_train, dataset_orig_val, dataset_orig_test,  sens_attr, model_type, dir_metrics, dir_mia_metrics, f_label, uf_label, unprivileged_groups, privileged_groups, ATTACK, THRESH_ARR, DISPLAY, SCALER, target_dataset=None, reference_dataset=None):
        print('\n------------------------------\n')
        print('[INFO] preprocessing--disparat impact remover ......')
        print('\n------------------------------\n')
        dir_mitigator = DIRMitigator()
        dir_metrics, dir_mia_metrics = dir_mitigator.run_mitigator(dataset_orig_train, dataset_orig_val, dataset_orig_test,  sens_attr, model_type, dir_metrics, dir_mia_metrics, f_label, uf_label, unprivileged_groups, privileged_groups, ATTACK, THRESH_ARR, DISPLAY, SCALER, target_dataset, reference_dataset)

        return dir_metrics, dir_mia_metrics

    def run_rew(self, dataset_orig_train, dataset_orig_val, dataset_orig_test, f_label, uf_label,  unprivileged_groups, privileged_groups, model_type, reweigh_metrics, reweigh_mia_metrics, ATTACK, THRESH_ARR, DISPLAY, SCALER, target_dataset=None, reference_dataset=None):
        print('\n------------------------------\n')
        print('[INFO] preprocessing--reweighting ......')
        print('\n------------------------------\n')
        rew_mitigator = ReweighMitigator()
        reweigh_metrics, reweigh_mia_metrics = rew_mitigator.run_mitigator(dataset_orig_train, dataset_orig_val, dataset_orig_test, f_label, uf_label,  unprivileged_groups, privileged_groups, model_type, reweigh_metrics, reweigh_mia_metrics, ATTACK, THRESH_ARR, DISPLAY, SCALER, target_dataset, reference_dataset)

        return reweigh_metrics, reweigh_mia_metrics

    def run_eg(self, dataset_orig_train, dataset_orig_val, dataset_orig_test, eg_metrics, eg_mia_metrics, 
        ...
        eg_metrics = eg_mitigator.run_mitigator(dataset_orig_train, dataset_orig_val, dataset_orig_test, eg_metrics, eg_mia_metrics, model_type, f_label, uf_label, unprivileged_groups, privileged_groups, ATTACK, THRESH_ARR, DISPLAY, SCALER, target_dataset, reference_dataset)
